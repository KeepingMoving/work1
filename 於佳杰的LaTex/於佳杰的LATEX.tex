...
\pagestyle{fancy}
\fancyhf{} % 清除默认设置
\renewcommand{\headrulewidth}{0.4pt} % 设置页眉线宽
\renewcommand{\footrulewidth}{0pt} % 设置页脚线宽为0，即不显示

\fancyhead[L]{Chapter \thechapter} % 左侧页眉显示章节号
\fancyhead[C]{\leftmark} % 中间页眉显示当前章节标题
\fancyhead[R]{\thepage} % 右侧页眉显示页码

\fancyfoot[C]{\textbf{Page \thepage}} % 中间页脚显示加粗的页码
如文档所示
\end{itemize}
\end{enumerate}
